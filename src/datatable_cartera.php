			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-collaboration position-left"></i> <span class="text-semibold">Administraci&oacute;n</span> Cartera</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="form_a_cartera.php"><i class="icon-collaboration"></i> Nueva Cartera</a></li>
									<li class="divider"></li>
								</ul>
							</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-cartera" style="font-size: 11px;">
							<thead>
								<tr>
									<th>Id</th>
									<th>Nombre</th>
