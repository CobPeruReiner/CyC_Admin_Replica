...
$(function() {
    ...
    $('.daterange-weeknumbers').daterangepicker({
        ...
        $('#plazo').val(restaFechas(fecha1,fecha2));
    });

    
    $('.daterange-weeknumbers').on('apply.daterangepicker', function(ev, picker) {
	...
	var fecha = new Date();
	var ano = fecha.getFullYear()-18;
	var ano2 = fecha.getFullYear();
    ...
    // Time picker
    $("#anytime-time,#anytime-time2,#anytime-time3,#anytime-time4,#anytime-time5,#anytime-time6").AnyTime_picker({
        format: "%H:%i:%s"
    });
