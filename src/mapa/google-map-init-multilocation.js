function initialize() {
    ...
    var markers = [
        ...
        ['Metadata Business Consulting', -12.1025732,-76.9377663],
        ['AMV Soluciones TI', -12.0825712,-77.08971]/*,
    ...
    var infoWindowContent = [
        ...
        '<p>Somos un equipo de profesionales de experiencia en temas de auditoría y tecnología aplicada a los procesos de control.</p>' +        '</div>'],
        ['<div class="info_content">' +
        '<h3>@amvsolucionesti</h3>' +
        '<p>Brindamos servicios de consultoría en las áreas de diseño y desarrollo web, dentro de un contexto de marketing digital.</p>' +
        '</div>']/*,
        ['<div class="info_content">' +
