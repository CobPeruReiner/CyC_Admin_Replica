			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-users position-left"></i> <span class="text-semibold">Administraci&oacute;n</span> Usuarios</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									...
									<li class="divider"></li>
									<li><a href="excel_personal.php"><i class="icon-file-excel"></i> Exportar</a></li>
								</ul>
							</li>
						</ul>
					</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-basic" style="font-size: 11px;">
							<thead>
								<tr>
									<th>Id</th>
