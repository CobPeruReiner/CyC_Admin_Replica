...
function generatePassword() {
    ...
    // Shuffle the password to mix the special character among the alphanumerics
...
eyeIcon.addEventListener('click', () => {
    ...
    this.classList.toggle('icon-eye8'); // Cambia la clase del ícono según sea necesario
    this.classList.toggle('icon-eye-blocked'); // Asegúrate de tener esta clase para el ícono de ocultar
})
