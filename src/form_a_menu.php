				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_menu.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Menu</h4>
						</div>
								...
								<legend class="text-semibold"><i class="icon-home6 position-left"></i> Datos Menu</legend>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label>Nombre</label>
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Personal" maxlength=50 required="required">
										</div>
									
										<div class="form-group">	
											<label><i id="icono_menu" name="icono_menu" class="icon-hand"></i> Icono</label>
