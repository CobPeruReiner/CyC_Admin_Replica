<?php
	...
	if (!isset($_SESSION['user_ls'])){
		...
		header("Location: datatable_telefono.php");
	}else{
		$objTelefono = clsTelefono::select($_REQUEST['id']);
	}
	$obj = new clsUsuario;
...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_telefono.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Modificar</span> Teléfono</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-m-telefono">
								...
								<legend class="text-semibold"><i class="icon-phone-plus position-left"></i> Datos Teléfono</legend>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input type="hidden" id="id" name="id" class="form-control" value="<?php echo $objTelefono['IDTELEFONO'];?>">
											<input type="text" id="documento" name="documento" class="form-control" placeholder="10767676651" maxlength=50 value="<?php echo $objTelefono['DOC'];?>" required="required">
										</div>
										
										<div class="form-group">
											<label>Fuente</label>
											<input type="text" id="fuente" name="fuente" class="form-control" placeholder="BD-AMV" maxlength=50 value="<?php echo $objTelefono['FUENTE'];?>"  required="required">
										</div>
										 ...
										 <div class="form-group">	
											<label>Número</label>
											<input type="number" id="numero" name="numero" class="form-control" placeholder="987654321" max=9999999999 value="<?php echo $objTelefono['NUMERO'];?>"  required="required">
										</div>
									...
									<div class="col-md-6">
										<fieldset>
											<div class="form-group">
												<label>Tipo</label>
												<input type="text" id="tipo" name="tipo" class="form-control" placeholder="Tipo" maxlength=50 value="<?php echo $objTelefono['TIPO'];?>"  required="required">
											</div>
											...
											<select id="operador" name="operador" data-placeholder="Seleccione" class="form-control" required="required">
												<option value="">Seleccione</option>
													<?php
														...
														if($datos['id']==$objTelefono['OPERADOR']){
											...
											<select id="personal" name="personal" data-placeholder="Seleccione" class="select" required="required">
												<option value=""></option>
													<?php
														...
														foreach($arr_datos as $datos)
														if($datos['id']==$objTelefono['IDPERSONAL']){
															echo '<option value="'.$datos['id'].'" selected>'.utf8_encode($datos['nombre']).' </option>';
