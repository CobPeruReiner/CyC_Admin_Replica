			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-database-add position-left"></i> <span class="text-semibold">Administraci&oacute;n</span> InfoAdc</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="form_a_infoadc.php"><i class="icon-database-add"></i> Nuevo InfoAdc</a></li>
									<li class="divider"></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-infoadc" style="font-size: 11px;">
							<thead>
								<tr>
									<th>Id</th>
									<th>Cartera</th>
