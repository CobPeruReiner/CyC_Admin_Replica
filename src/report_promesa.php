...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="col-md-12">
									<h6 class="panel-title">Promesas</h6>
...
$(document).ready(function(){
    ...
    $('.daterange-ranges span').html(moment().subtract('days', 29).format('YYYY-MM-DD') + ' - ' + moment().format('YYYY-MM-DD'));
      ...
      $("#btn_excel").click(function(e) {
		e.preventDefault();
		 ...
		 listar_1(2,$('.daterange-ranges span').text().substring(0, 10),$('.daterange-ranges span').text().substring(13, 23),$('#cuenta').val(),$('#cliente').val());
    ...
    $("#btn_busca").click(function(e) {
        ...
        bootbox.confirm("\u00bfDesea generar archivo excel?", function(result) {
    		if (result){
    			abrirNuevaVentana('excel_promesa.php?fecha_inicio=' +  $('.daterange-ranges span').text().substring(0, 10)+ ' 00:00:00' + '&fecha_fin='+ $('.daterange-ranges span').text().substring(13, 23)+ ' 23:59:59'+ '&cuenta='+$('#cuenta').val()+'&cliente=');
    		}
    	}); 
    });
     ...
     $("#btn_busca2").click(function(e) {
        ...
        bootbox.confirm("\u00bfDesea generar archivo excel?", function(result) {
    		if (result){
    			abrirNuevaVentana('excel_promesa.php?fecha_inicio=' +  $('.daterange-ranges span').text().substring(0, 10)+ ' 00:00:00' + '&fecha_fin='+ $('.daterange-ranges span').text().substring(13, 23)+ ' 23:59:59'+ '&cliente='+$('#cliente').val()+'&cuenta=');
    		}
    	}); 
    });
