...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="datatable_mi_bandeja.php"><i class="icon-arrow-left52 position-left"></i></a></li>
						...
						<ul class="breadcrumb-elements">
						    ...
						    <?php 
								 if(isset($objDescribe2["documento"]) ? strlen(utf8_encode($objDescribe2["documento"])) : strlen(utf8_encode($objDescribe2["DOCUMENTO"]))>=1){
										 
								?>
								<li>
								 <a href="javascript:ventana_gestion('<?php echo  $_REQUEST['identificador'] .'&id='.   $_REQUEST['id'].'&cuenta='.   $_REQUEST['cuenta'];?>')" class=""><i class="icon-play position-left" title="Gestión"></i><span>
								Agregar Gestión Call</span></a>
								 </li>  

								 <li>
								 <a href="javascript:ventana_gestion_campo('<?php echo  $_REQUEST['identificador'] .'&id='.   $_REQUEST['id'].'&cuenta='.   $_REQUEST['cuenta'];?>')" class=""><i class="icon-play position-left" title="Gestión"></i><span>
								Agregar Gestión Campo</span></a>
								 </li>

								 <?php }else{ ?>
								 <li>   
							    <a href="#"  style="color: red; opacity: 0.5;" class=""><i class="icon-play position-left"  title="Gestión"></i><span>
								Gestión</span></a>
								</li>
							    <?php } ?>
								...
								<li>
								<a href="javascript:ventana_campaing('<?php echo  $_REQUEST['identificador'] .'&id='.   $_REQUEST['id'];?>')" ><i class="icon-stack-check position-left" title="Campañas"></i><span>
								Campañas</span></a>
							    </li>
							    <?php }else{ ?>
							    <li>
							    <a href="#"  style="color: red; opacity: 0.5;" class=""><i class="icon-stack-check position-left"></i><span>
								Campañas</span></a>
								</li>
								<?php } ?>
								 ...
								 <li>
								<a href="javascript:ventana_pago('<?php echo isset($objDescribe2["identificador"]) ? utf8_encode($objDescribe2["identificador"]) : utf8_encode($objDescribe2["IDENTIFICADOR"]);  ?>')" class="circle pulse rose"><i class="icon-coins position-left" title="Pagos"></i> <span></span></a>
								</li>
								 <?php }else{ ?>
								 <li>
								 <a href="#"  style="color: red; opacity: 0.5;" class=""><i class="icon-coins position-left"></i><span>
								Pagos</span></a>
								</li>
								<?php } ?>
			...
			<div class="content">
				...
				<!--<div class="panel panel-flat">
			     ...
			     <!-- Wizard with validation -->
					...
					<div class="panel-body">
						...
						<h6> <i class="icon-user"></i>Datos Cliente</h6>
							<fieldset>
									<div class="panel-body">
									<?php 
													...
													?>
															...
															<div class="col-lg-3">
															<label><i class="icon-checkmark2"></i> 
															<b><?php echo ($objDescribe[$i]['campo']); ?>:</b>
															</label>
															<span id="<?php echo ($objDescribe[$i]['campo']) ?>"> <?php echo $objDescribe2[$objDescribe[$i]['campo']] ?>  </span>
															</div>
							...
							<h6><i class="icon-credit-card"></i> Datos Cuenta</h6>
							<fieldset>
								<div class="panel-body">
									<?php 
													...
													?>
															...
															<div class="col-lg-3">
															<label >
															 <i class="icon-shield-check"></i> <b><?php echo ($objDescribeg2[$i]['campo']); ?>: </b>
															</label>
															<span id="<?php echo $objDescribe2[$objDescribeg2[$i]['campo']] ?>"> <?php echo $objDescribe2[$objDescribeg2[$i]['campo']] ?> </span>
															</div>
							...
							<h6><i class="icon-store"></i> Datos Deuda</h6>
							<fieldset>
								<div class="panel-body">
									<?php 
													...
													?>
															...
															<div class="col-lg-3">
															<label >
															  <i class="icon-radio-checked"></i> <b><?php echo ($objDescribeg3[$i]['campo']); ?>: </b>
															</label>
															<span id="<?php echo $objDescribe2[$objDescribeg3[$i]['campo']] ?>"> <?php echo $objDescribe2[$objDescribeg3[$i]['campo']] ?> </span>
															</div>
				...
				<div class="panel panel-flat" id="div_gestion" name="div_gestion">
						<div class="panel-heading">
							<h5 class="panel-title">Gestiones</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <table class="table table-togglable table-striped table-bordered nowrap" style="font-size: 11px; width:50%;">
							<thead style="background: #e6e4e4;">
								<tr>
									<th>#</th>
									<th>Fec. Gestión</th>
					...
					<form class="form-gestion" action="#">
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								...
								<div class="col-lg-4">
									<label></label><a title="Teléfono" id="telefono_click" name="telefono_click"><i class="icon-phone-plus"></i></a></a>
								...
								<div class="col-lg-4">
									<label>Pisos</label>
									<input type="text" id="pisos" name="pisos" class="form-control" maxlength="20"  >
									
								</div>
								
								<div class="col-lg-4">
									<label>Puerta</label>
									<input type="text" id="puerta" name="puerta" class="form-control" placeholder="" maxlength="20"  >
...
function ventana_gestion(identificador){	
        opciones = 'width = 1100, height = 350, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=yes, copyhistory=no, left = 200, top = 150';
        url = 'gestion.php?identificador='+identificador;
        window.open(url, 'mp4', opciones); 
}

function ventana_gestion_campo(identificador){	
        opciones = 'width = 1100, height = 350, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=yes, copyhistory=no, left = 200, top = 150';
        url = 'gestion_campo.php?identificador='+identificador;
        window.open(url, 'mp4', opciones); 
}
...
function listar(identificador,cuenta,control){
 $.ajax({
        ...
        dataType: 'json',
            ...
            if (data.codigo==0){
                $('#div_gestion').hide();
				$(".table-togglable tbody").html("");
			}else{
			    $('#div_gestion').show();
			    
			    
                var table=$('.table-togglable').removeAttr('width').dataTable({
                    'data': data.arr_datos,
                    "order": [[ 0, "desc" ]],
                    "scrollX":        true,
                    "scrollCollapse": true,
                    ...
                    "columnDefs": [
                            ...
                            },*/
                            {
                                        ...
                                        var btn_2='';
                                        if(data[11]==0){
                                            promesa='color: red; opacity: 0.5;';
                                            btn_1=''
                                        }else{
                                            promesa='';
                                            btn_1='btn_promesa circle pulse rose';
                                        }
                                        
                                        if(data[12]==0){
                                            direccion='color: red; opacity: 0.5;';
                                            btn_2=''
                                        }else{
                                            direccion='';
                                            btn_2='btn_direccion circle pulse rose';
                                        }
                                 
                                          return  '<input class="txt_id" type="hidden" value="'+data[17]+'"/><input class="txt_id2" type="hidden" value="'+data[16]+'"/><button style="'+ promesa +'" class="'+btn_1+'" type="button" title="Promesa"><i class="icon-calendar" style="font-size: 12px;"></i> </button><button style="'+ direccion +'" class="'+btn_2+'" type="button" title="Domicilio"><i class="icon-home8" style="font-size: 12px;"></i> </button>'
                                        }
                            }
                        ],
                        fixedColumns: true
...
function btn_table2(){
    ...
    $(".btn_promesa").unbind();
    $(".btn_direccion").unbind();
    $(".btn_promesa").click(function (e) {
        var id = $(this).parent().find(".txt_id").val();
        var id2 = $(this).parent().find(".txt_id2").val();
    ...
    $(".btn_direccion").click(function (e) {
        var id = $(this).parent().find(".txt_id").val();
        var id2 = $(this).parent().find(".txt_id2").val();
