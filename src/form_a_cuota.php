...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_cuota.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Cuota</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-cuota">
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" id="fechacuota" name="fechacuota" required="required" class="form-control pickadate2" placeholder="<?php echo date('Y-m-d');?>" /> 
