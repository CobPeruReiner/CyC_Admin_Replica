			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-credit-card position-left"></i> <span class="text-semibold">Administraci&oacute;n</span> Cuota</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="form_a_cuota.php"><i class="icon-credit-card"></i> Nuevo Cuota</a></li>
									<li class="divider"></li>
									<li><a href="carga_cuota.php"><i class="icon-libreoffice"></i> Cargar CSV</a></li>
								</ul>
							</li>
						</ul>
					</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-cuota" style="font-size: 11px;">
							<thead>
								<tr>
									<th>Id</th>
									<th>Nombre</th>
