		...
		success:  function (response) {
			...
			if (response.codigo==0){
				...
				for (var i=0; i < response.arr_datos.length; i++) {
					str_li += '<li class="media" ><div class="media-left"><img src="assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div><div class="media-body"><a href="#" style="font-size: x-small;" class="media-heading text-semibold">'+response.arr_datos[i][0]+'</a><span class="display-block text-muted text-size-small" style="font-size: x-small;">'+response.arr_datos[i][1]+'</span></div><div class="media-right media-middle"><span class="status-mark border-success"></span></div></li>';
				}			
				//console.log(str_li);
