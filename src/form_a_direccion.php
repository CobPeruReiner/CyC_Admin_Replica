...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_direccion.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Dirección</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-direccion">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
										 ...
										 <div class="form-group">	
											...
											<input type="text" id="direccion" name="direccion" class="form-control" placeholder="Calle Angelica Palma 123" maxlength=100 required="required">
										</div>
										
										 <div class="form-group">	
											<label>Referencia</label>
											<input type="text" id="referencia" name="referencia" class="form-control" placeholder="Sodimac San Miguel" maxlength=100 required="required">
										</div>
