<?php
	...
	if (!isset($_SESSION['user_ls'])){
		...
		header("Location: datatable_cliente.php");
	}else{
		$objCliente= clsCliente::select($_REQUEST['id']);
	}
	$obj = new clsUsuario;
...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_cliente.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Modificar</span> Cliente</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="datatable_cliente.php"><i class="icon-user-check"></i> Cliente</a></li>
									<li class="divider"></li>
								</ul>
							</li>
						</ul>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-m-cliente">
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
								<legend class="text-semibold"><i class="icon-user-check position-left"></i> Datos Cliente</legend>
								
									<div class="col-md-6">
										<fieldset>
										<div class="form-group">
											<label>Nombre</label>
											<input type="hidden" id="id" name="id" class="form-control" value="<?php echo $objCliente['id'];?>">
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Cobranzas Perú" maxlength=50 required="required" value="<?php echo utf8_encode($objCliente['nombre']);?>">
										</div>
										
										<div class="form-group">
											<label>Identificador</label>
											<input type="text" id="identificador" name="identificador" class="form-control" placeholder="00112233-AMV" maxlength=50 required="required" value="<?php echo utf8_encode($objCliente['identificador']);?>">
										</div>
											...
											<select id="personal" name="personal" data-placeholder="Seleccione" class="select" required="required">
												<option value=""></option>
													<?php
														...
														$obj = new clsCliente;
														$arr_datos = $obj->consulta_personal();
														foreach($arr_datos as $datos)
														if($datos['id']==$objCliente['idpersonal']){
