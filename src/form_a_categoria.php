...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_categoria.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Categoria</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-categoria">
								...
								<legend class="text-semibold"><i class="icon-file-zip position-left"></i> Datos Categoria</legend>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label>Nombre</label>
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Categoria I" maxlength=50 required="required">
										</div>
										<div class="form-group">
