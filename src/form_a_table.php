									...
									<div class="col-md-3">
										...
										<div class="form-group">	
											...
											<div style="display: -webkit-box;">	
												<input type="text" class="form-control" value="identificador" disabled />
												<select data-placeholder="Seleccione" class="form-control" disabled >
...
<script>
			$(function() {
					...
					$("#field_name").val("documento");
					$("#tipo").val("1");
					
					$("#cartera").change(function(e) {
							var fecha='<?php echo date("_Ymd_his")?>';
