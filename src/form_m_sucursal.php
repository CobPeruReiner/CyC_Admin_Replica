<?php
	...
	if (!isset($_SESSION['user_ls'])){
		...
		header("Location: datatable_sucursal.php");
	}else{
		$objSucursal= clsSucursal::select($_REQUEST['id']);
	}
	$obj = new clsUsuario;
...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_sucursal.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Modificar</span> Sucursal</h4>
						</div>

						<div class="heading-elements">
							<div class="heading-btn-group">
								<a href="#" class="btn btn-link btn-float has-text"><i class="icon-bars-alt text-primary"></i><span>Estadísticas</span></a>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="datatable_sucursal.php"><i class="icon-home5"></i> Sucursal</a></li>
									<li class="divider"></li>
								</ul>
							</li>
						</ul>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-m-sucursal">
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
								<legend class="text-semibold"><i class="icon-home5 position-left"></i> Datos Sucursal</legend>
								
									<div class="col-md-6">
										<fieldset>
										<div class="form-group">
											<label>Nombre</label>
											<input type="hidden" id="id" name="id" class="form-control" value="<?php echo $objSucursal['IDSUCURSAL'];?>">
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Sucursal I" maxlength=70 required="required" value="<?php echo utf8_encode($objSucursal['SUCURSAL']);?>">
										</div>
											...
											<select id="departamento" name="departamento" data-placeholder="Seleccione" class="select" required="required">
												<option value=""></option>
													<?php
														...
														if($datos['id']==$objSucursal['codDepartamento']){
										...
										<div class="form-group">
											...
											<input type="text" id="direccion" name="direccion" class="form-control" placeholder="Av. Marina 253" maxlength=70 required="required" value="<?php echo utf8_encode($objSucursal['DIRECCION']);?>">
										</div>
										
										<div class="form-group">
											<label>Teléfono</label>
											<input type="text" id="telefono" name="telefono" class="form-control" placeholder="987654321" maxlength=9 required="required" value="<?php echo utf8_encode($objSucursal['TLF']);?>">
										</div>
			...
			function cargar_provincias(id) {
				$.ajax({
					...
					success:  function (response) {
						...
						var departamento = $("#departamento").val();
						var provincia= '<?php echo isset($objSucursal['codProvincia']) ? $objSucursal['codProvincia'] : 0 ?>';
			...
			function cargar_distritos(id,id2) {
				$.ajax({
					...
					success:  function (response) {
						...
						var departamento = $("#departamento").val();
						var provincia= '<?php echo isset($objSucursal['codProvincia']) ? $objSucursal['codProvincia'] : 0 ?>';
						var distrito= '<?php echo isset($objSucursal['codDistrito']) ? $objSucursal['codDistrito'] : 0 ?>';
						//console.log(departamento+'|'+provincia);
						if (distrito >0){
