...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_sucursal.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Sucursal</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-sucursal">
								...
								<legend class="text-semibold"><i class="icon-home5 position-left"></i> Datos Sucursal</legend>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label>Nombre</label>
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Sucursal I" maxlength=70 required="required">
										</div>
										...
										<div class="form-group">
											...
											<input type="text" id="direccion" name="direccion" class="form-control" placeholder="Av. Marina 253" maxlength=70 required="required">
										</div>
										
										<div class="form-group">
											<label>Teléfono</label>
											<input type="text" id="telefono" name="telefono" class="form-control" placeholder="987654321" maxlength=9 required="required">
										</div>
