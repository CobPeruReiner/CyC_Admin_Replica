...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="col-md-12">
									<h6 class="panel-title">Tiempos Asesor</h6>
...
$(document).ready(function(){
    ...
    $('.daterange-ranges span').html(moment().subtract('days', 29).format('YYYY-MM-DD') + ' - ' + moment().format('YYYY-MM-DD'));
      ...
      $("#btn_excel").click(function(e) {
		e.preventDefault();
		 ...
		 listar_1(4,$('.daterange-ranges span').text().substring(0, 10),$('.daterange-ranges span').text().substring(13, 23));
    ...
    $("#btn_busca").click(function(e) {
        ...
        bootbox.confirm("\u00bfDesea generar archivo excel?", function(result) {
    		if (result){
    			abrirNuevaVentana('excel_login.php?fecha_inicio=' +  $('.daterange-ranges span').text().substring(0, 10)+ ' 00:00:00' + '&fecha_fin='+ $('.daterange-ranges span').text().substring(13, 23)+ ' 23:59:59');
    		}
    	}); 
    });
  ...
  // listar_1(4,fecha1,fecha2);
    
    
  });
  
  
function listar_1(control,fecha_i,fecha_f){
 $.ajax({
        data: {control:control,fecha_i:fecha_i,fecha_f:fecha_f},
