...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_cartera.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Cartera</h4>
						</div>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-cartera">
								...
								<legend class="text-semibold"><i class="icon-collaboration  position-left"></i> Datos Cartera</legend>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label>Nombre</label>
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Cartera I" maxlength=50 required="required">
										</div>
										
										<div class="form-group">
											<label>Tramo</label>
											<input type="number" id="tramo" name="tramo" class="form-control" placeholder="123" required="required">
										</div>
										<div class="form-group">
											<label>Central</label>
											<input type="text" id="central" name="central" class="form-control" placeholder="105" maxlength=50 required="required">
										</div>
