...
<?php include 'cabecera.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="datatable_horario.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Registrar</span> Horario</h4>
						</div>
						...
						<ul class="breadcrumb-elements">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a href="form_a_user.php"><i class="icon-watch2"></i> Horario</a></li>
									<li class="divider"></li>
								</ul>
							</li>
						</ul>
				...
				<!-- Content area -->
				<div class="content">
					<form action="#" class="form-a-horario">
								...
								<legend class="text-semibold"><i class="icon-watch position-left"></i> Datos Horario</legend>
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<label>Nombre</label>
											<input type="text" id="nombre" name="nombre" class="form-control" placeholder="Oficina" maxlength=70 required="required">
										</div>
									...
									<div class="col-md-3">
										<fieldset>
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" id="anytime-time" name='anytime-time' value="08:00:00" >
											</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><i class="icon-watch2"></i></span>
													<input type="text" class="form-control" id="anytime-time2" name='anytime-time2' value="18:00:00" >
												</div>
											</div>
									...
									<div class="col-md-3">
										...
										<fieldset>
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-watch2"></i></span>
												<input type="text" class="form-control" id="anytime-time3" name='anytime-time3' value="00:00:00" readonly="">
											</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><i class="icon-watch2"></i></span>
													<input type="text" class="form-control" id="anytime-time4" name='anytime-time4' value="00:00:00" readonly="">
												</div>
											</div>
									...
									<div class="col-md-3">
										...
										<fieldset>
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-watch2"></i></span>
												<input type="text" class="form-control" id="anytime-time5" name='anytime-time5' value="00:00:00" readonly="">
											</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><i class="icon-watch2"></i></span>
													<input type="text" class="form-control" id="anytime-time6" name='anytime-time6' value="00:00:00" readonly="">
												</div>
											</div>
